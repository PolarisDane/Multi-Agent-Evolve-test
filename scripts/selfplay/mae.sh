...
python -m absolute_zero_reasoner.main_azr_ppo \
    ...
    actor_rollout_ref.model.path=/ceph/home/muhan01/huggingfacemodels/Qwen2.5-3B-Instruct \
    ...
    trainer.default_local_dir=/ceph/home/muhan01/wyd/ICML_rebuttal/Multi-Agent-Evolve-test/checkpoints \
    trainer.critic_warmup=0 \
    trainer.logger=['console','wandb'] \
    trainer.project_name='MAE' \
    trainer.experiment_name='MAE_3B_gradient_analysis' \
